...
size_t const SPU_MEM_SIZE_SQRT = 50;
...
#define INVALID_POSITION                4'000
#define NOT_ENOUGH_ARGUMENTS            4'001
#define INVALID_INDEX                   4'002
#define STACK_NOT_EMPTY_AFTER_EXECUTION 4'003
#define NO_HLT_COMMAND_REACHED          4'004
...
#define SPU_HASH_UNMATCH          0B100'000'000'000'000'000
#define SPU_CANARY_SPOILED        0B1'000'000'000'000'000'000
#define SPU_INVALID               0B10'000'000'000'000'000'000
#define STACK_NULL_BYTE_CODE      0B100'000'000'000'000'000'000
